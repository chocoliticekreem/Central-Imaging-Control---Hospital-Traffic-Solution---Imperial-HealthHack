...
src_points = np.float32([
    [711, 765],  # Top-Left
    [1493, 660],  # Top-Right
    [1703, 829],  # Bottom-Right
    [747, 954]   # Bottom-Left
])

# MIRRORED UP-DOWN (Vertical Flip)
# Note how the '0' and 'MAP_HEIGHT' values for the Y-axis are swapped compared to before.
dst_points = np.float32([
    [0, 0],                   # Camera Top-Left  -> Map Top-Left
    [MAP_WIDTH, 0],           # Camera Top-Right -> Map Top-Right
    [MAP_WIDTH, MAP_HEIGHT],  # Camera Bot-Right -> Map Bottom-Right
    [0, MAP_HEIGHT]           # Camera Bot-Left  -> Map Bottom-Left
])
...
cap = cv2.VideoCapture('aegis_flow/vision/CCTV_demo.mp4') 
